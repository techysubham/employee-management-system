...
function ResourceManagerDashboard({ 
  ...
  const [darkMode, setDarkMode] = useState(() => {
    const saved = localStorage.getItem('resource-manager-dark-mode');
  ...
  const toggleDarkMode = () => {
    ...
    setDarkMode(newMode);
    localStorage.setItem('resource-manager-dark-mode', JSON.stringify(newMode));
  };
  ...
  const fetchDepartmentIssues = async () => {
    try {
      const response = await axios.get(`${API_URL}/issues/department/resource-manager`);
  ...
  const departmentEmployees = employees.filter(emp => emp.department === 'resource-manager');
  
  // Filter tasks assigned to department employees
  const departmentTasks = tasks.filter(task => {
    const employee = employees.find(emp => emp.id === task.employeeId);
    return employee && employee.department === 'resource-manager';
  });
  ...
  const departmentAttendance = attendance.filter(att => {
    ...
    return employee && employee.department === 'resource-manager' && att.date === selectedDate;
  });
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={{ 
        ...
        <div style={cardStyle}>
          <h3 style={{ margin: '0 0 15px 0', color: '#f39c12' }}>📋 Resource Tasks</h3>
        ...
        <div style={cardStyle}>
          <h3 style={{ margin: '0 0 15px 0', color: '#f39c12' }}>👥 Team Size</h3>
          <div style={{ fontSize: '32px', fontWeight: 'bold', marginBottom: '10px' }}>
            {totalEmployees}
          </div>
      ...
      <div style={cardStyle}>
        ...
        {loading ? (
          ...
          <p style={{ color: '#7f8c8d', fontStyle: 'italic' }}>No issues assigned to resource manager department</p>
        ) : (
      ...
      <div style={cardStyle}>
        <h3 style={{ marginBottom: '20px', color: '#9b59b6' }}>📈 Resource Management Metrics</h3>
      ...
      <div style={cardStyle}>
        <h3 style={{ marginBottom: '20px', color: '#2ecc71' }}>🎯 Resource Management Areas</h3>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '15px' }}>
          <div style={{ 
            ...
            <h4 style={{ margin: '0 0 10px 0', color: '#3498db' }}>👥 Human Resources</h4>
            <p style={{ margin: 0, fontSize: '14px', opacity: 0.7 }}>
              Managing employee allocation and workforce planning
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <h4 style={{ margin: '0 0 10px 0', color: '#f39c12' }}>📦 Asset Management</h4>
            <p style={{ margin: 0, fontSize: '14px', opacity: 0.7 }}>
              Tracking and optimizing company assets and resources
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <h4 style={{ margin: '0 0 10px 0', color: '#e74c3c' }}>💰 Budget Planning</h4>
            <p style={{ margin: 0, fontSize: '14px', opacity: 0.7 }}>
          ...
          <div style={{ 
            ...
            <h4 style={{ margin: '0 0 10px 0', color: '#9b59b6' }}>📊 Resource Analytics</h4>
            <p style={{ margin: 0, fontSize: '14px', opacity: 0.7 }}>
